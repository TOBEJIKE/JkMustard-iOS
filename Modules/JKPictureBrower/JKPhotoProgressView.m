...
@implementation JKPhotoProgressView
...
- (void)drawRect:(CGRect)rect{
    ...
    CGFloat radians = (M_PI/180.0 * ((_progress*359.9)-90));
    ...
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius, (M_PI/180.0 * (270)), (M_PI/180.0 * (-90)), NO);
    ...
    CGPathAddArc(progressPath, NULL, centerPoint.x, centerPoint.y, radius, (M_PI/180.0 * (270)), radians, NO);
